...
public class DisablePack implements CommandExecutor{
    @Override
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (Config.isPackEnabled(packName)) {
            Config.disablePack(packName);
            src.sendMessage(Text.of(Config.getTriviaPrefix(),
                    TextColors.WHITE, "Disabled the trivia pack ", TextColors.LIGHT_PURPLE, packName, TextColors.WHITE, "!"));
            src.sendMessage(Text.of(Config.getTriviaPrefix(),
            ...
            src.sendMessage(Text.of(Config.getTriviaPrefix(),
                    TextColors.WHITE, "The trivia pack ", TextColors.LIGHT_PURPLE, packName, TextColors.WHITE, " is not enabled!"));
            return CommandResult.empty();
        }
    }
}
